...
generate_and_sample_random_functions(dimension=args.dimension,sample_count_dimension_factor=args.sample_count_dimension_factor,n_functions=random_problem_count, sample_range=sample_range)
...
sample_M4_problems(args.dimension,sample_count_dimension_factor=args.sample_count_dimension_factor,n_functions=m4_problem_count, sample_range=sample_range)
